...
export const Sidebar = () => {
  ...
  const normalLinkStyle =
    "flex items-center gap-3 hover:bg-primary p-3 justify-center xl:justify-start cursor-pointer font-semibold text-main rounded";
            ...
            <div className="hidden px-2 py-4 xl:block">
              ...
              <div className="pr-4">
                <GoogleLogin
                  ...
                  render={(renderProps) => (
                    <button
                      className="bg-white text-lg text-main border-[1px] border-main font-semibold px-6 py-3 rounded-md outline-none w-full mt-3 hover:text-white hover:bg-main"
